 ...
 * $Id$
 * $Log$
 * Revision 1.6  2014/10/13 08:53:10  j_novak
 ...
 * LORENE
 *
 * Revision 2.0  1999/02/22  15:46:39  hyc
 * *** empty log message ***
 *
 *
 * $Header$
...
void cftlegpp(const int* deg, const int* dimf, double* ff, const int* dimc,
		double* cf)
{
...
//--------------------------------------------------------------
    ...
    cftcosp(deg, dimf, ff, dimc, cf_cs) ;

//--------------------------------------------------------------
// 2/ Transformation  cos(2l theta) ---> Legendre 
//--------------------------------------------------------------
