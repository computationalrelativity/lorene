...
void Bin_hor::solve_lapse (double precision, double relax) {
    ...
    const Vector& dln_psi_un = hole1.ln_psi().derive_cov(hole1.ff) ; 
    const Vector& dln_psi_deux = hole2.ln_psi().derive_cov(hole2.ff) ; 
    ...
    - 2.* contract(dln_psi_un, 0, hole1.n_auto().derive_con(hole1.tgam()), 0)
  ...
  - 2.* contract(dln_psi_deux, 0, hole2.n_auto().derive_con(hole2.tgam()), 0)
...
void Bin_hor::solve_shift (double precision, double relax) {
    ...
    source_un = 2.* contract(hole1.aa(), 1, 
			     hole1.n_auto().derive_cov(hole1.ff) 
			    - 6.*hole1.n_auto()*hole1.dpsi()/hole1.psi(), 0) ;
     
    tmp_vect_un = 0.66666666666666666* hole1.trK.derive_con(hole1.tgam())
	* hole1.decouple ;
	...
	* hole1.hdirac() ;
    ...
    source_deux = 2.* contract(hole2.aa(), 1, 
			     hole2.n_auto().derive_cov(hole2.ff) 
			    - 6.*hole2.n_auto()*hole2.dpsi()/hole2.psi(), 0) ;
     
    tmp_vect_deux = 0.66666666666666666* hole2.trK.derive_con(hole2.tgam())
	* hole2.decouple ;
	...
	* hole2.hdirac() ;
    ...
    Valeur lim_x_un (hole1.boundary_beta_x(omega)) ;
    Valeur lim_y_un (hole1.boundary_beta_y(omega)) ;
    Valeur lim_z_un (hole1.boundary_beta_z(omega)) ;
    Valeur lim_x_deux (hole2.boundary_beta_x(omega)) ;
    Valeur lim_y_deux (hole2.boundary_beta_y(omega)) ;
    Valeur lim_z_deux (hole2.boundary_beta_z(omega)) ;
    ...
    Tenseur beta1 (hole1.mp, 1, CON, hole1.mp.get_bvect_cart()) ;
    ...
    Tenseur beta2 (hole2.mp, 1, CON, hole2.mp.get_bvect_cart()) ;
