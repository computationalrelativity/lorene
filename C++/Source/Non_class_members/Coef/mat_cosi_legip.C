 ...
 * ---------------------------
 *  double* mat_cosi_legip : pointeur sur le tableau contenant l'ensemble
 ...
 *
 *   cos((2j+1) theta) = som_{l=m/2}^{nt-2} A_{mlj} P_{2l+1}^m( cos(theta) )
 *						pour 0 <= j <= nt-2
 *
 ...
 * LORENE
 *
 * Revision 2.0  2000/09/28  10:02:18  eric
 * *** empty log message ***
 *
 *
 * $Header$
...
// Variable de loch
int loch_mat_cosi_legip = 0 ;

//******************************************************************************

double* mat_cosi_legip(int np, int nt) {
...
//    #pragma critical (loch_mat_cosi_legip)
    {
