 ...
 * $Id$
 * $Log$
 * Revision 1.15  2004/12/22 18:17:08  f_limousin
...
// Standard constructor
  Isol_hor(Map_af& mpi, const Base_vect& triad, const Metric_flat& ff_in,
	   const Metric& metgamt, const Sym_tensor& gamt_point_in, 
	   const Scalar& trK_in, const Scalar& trK_point_in, int depth_in) ;
