...
void Binary::orbit(double fact_omeg_min, double fact_omeg_max, double& xgg1, 
	...
	const Metric& gamij = et[i]->get_gamij() ;

	const Scalar& gg00 = gamij.cov()(1,1) ;
	const Scalar& gg10 = gamij.cov()(2,1) ;
	const Scalar& gg20 = gamij.cov()(3,1) ;
	const Scalar& gg11 = gamij.cov()(2,2) ;
	const Scalar& gg21 = gamij.cov()(3,2) ;
	const Scalar& gg22 = gamij.cov()(3,3) ;
