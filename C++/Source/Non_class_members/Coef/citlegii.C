...
void citlegii(const int* deg, const int* dimc, double* cf, const int* dimf,
		   double* ff)
{
...
//------------------------------------------------
// 1/ Transformation Legendre ---> sin( 2j theta)
//------------------------------------------------

    chb_legii_sinp(deg , cf, cf_cs) ;  

//--------------------------------------------------------------
// 2/ Transformation sin( (2j+1) theta) ---> esp. des configurations
//--------------------------------------------------------------

    citsinp(deg, dimc, cf_cs, dimf, ff) ;
