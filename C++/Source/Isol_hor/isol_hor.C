...
void Isol_hor::operator=(const Isol_hor& isolhor_in) {
    ...
    gamt_point_evol = isolhor_in.gamt_point_evol ; 
                ...
                //----------------------------------------------------//
                //  Update of fields from base class Time_slice_max   //
                //----------------------------------------------------//

// after a change in gamt_point (and gam_point) we must update:
// trk, k_dd, k_uu, aa 
...
// gam_point and gamt_point must be updated here


// POR QUE ES NECESARIO INTRODUCIR ESTO? NO ESTA TENIDO EN CUENTA POR 
// SER UNA CLASE DERIVADA DE TSLICE_DIRAC_MAX?
...
const Sym_tensor& Isol_hor::hh() const {
...
const Scalar& Isol_hor::trk() const {
...
const Vector& Isol_hor::hdirac() const {
...
/*
                //-----------------------------------------//
                //  Update of fields from Tslice_dirac_max //
                //-----------------------------------------//


const Scalar& Hor_isol::khi() const {
...
const Scalar& Hor_isol::mu() const {
...
const Scalar& Hor_isol::trh() const {
