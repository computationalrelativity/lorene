/*
 * Methods of class Mg3d to get the Legendre standard spectral bases for scalar and
 *  vector fields.
 */

/*
 *   Copyright (c) 1999 Eric Gourgoulhon
...
char mg3d_leg_base_C[] = "$Header$" ;

/*
 * $Id$
 * $Log$
 * Revision 1.1  2013/01/11 15:44:54  j_novak
...
Base_val Mg3d::leg_base_scal() const {
...
Base_val Mg3d::leg_base_scal_odd() const {
...
Base_val** Mg3d::leg_base_vect_cart() const {
...
// 		    base1 = base1 | R_LEGPIM_P ;  
// 		    base2 = base2 | R_LEGPIM_P ;  
// 		    base3 = base3 | R_LEGPIM_I ;  
...
// echantillonnage fin (1/r)
		    ...
		    default : 
			cout << 
	    "Mg3d::leg_base_vect_cart : le cas type_p, type_t, type_r = " 
...
// 		    base1 = base1 | R_LEGPI_P ;  
// 		    base2 = base2 | R_LEGPI_P ;  
// 		    base3 = base3 | R_LEGPI_P ;  
...
// echantillonnage fin (1/r)
		...
		default : 
		    cout << 
		"Mg3d::leg_base_vect_cart : le cas type_p, type_t = " 
			  << type_p<< " " <<type_t << endl ;
		    cout << 
			  " dans la zone l = " << l << " n'est pas prevu ! " 
			  << endl ;
...
// echantillonnage fin (1/r)
	...
	default : 
	    cout << 
	    "Mg3d::leg_base_vect_cart : le cas type_p = " << type_p << endl ;
...
Base_val** Mg3d::leg_base_vect_spher() const {
...
// 	  base1 = base1 | R_LEGPIM_I ;  
// 	  base2 = base2 | R_LEGPIM_I ;  
// 	  base3 = base3 | R_LEGPIM_I ;  
...
// echantillonnage fin (1/r)
	...
	default : 
	  cout << 
	    "Mg3d::leg_base_vect_sphere : le cas type_p, type_t, type_r = " 
	       << type_p<< " " << type_t<< " " <<type_r0 << endl ;
	  cout << " dans la zone l = " << l << " n'est pas prevu ! " 
	       << endl ;
	  abort () ;
...
// 		      base1 = base1 | R_LEGPI_I ;  
// 		      base2 = base2 | R_LEGPI_I ;  
// 		      base3 = base3 | R_LEGPI_P ;  
...
// echantillonnage fin (1/r)
	...
	break ;	// fin du cas type_t = SYM
      ...
      default : 
	cout << "Mg3d::leg_base_vect_spher : le cas type_p, type_t = " 
	     << type_p<< " " <<type_t << endl ;
	cout << " dans la zone l = " << l << " n'est pas prevu ! " 
	     << endl ;
	abort () ;
...
// echantillonnage fin (1/r)
	...
	default : 
	  cout << 
	    "Mg3d::leg_base_vect_spher : le cas type_p, type_t, type_r = " 
	       << type_p<< " " <<type_t<< " " <<type_r0 << endl ;
	  cout << " dans la zone l = " << l << " n'est pas prevu ! " 
	       << endl ;
	  abort () ;
...
// echantillonnage fin (1/r)
    ...
    default : 
      cout << 
	"Mg3d::leg_base_vect_spher : le cas type_p = " << type_p << endl ;
      cout << " dans la zone l = " << l << " n'est pas prevu ! " 
	   << endl ;
      abort () ;
