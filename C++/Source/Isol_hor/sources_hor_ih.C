...
Scalar Isol_hor::source_psi_hor_ih( const Scalar* p_ener_dens, const Vector* p_mom_dens, 
...
Scalar Isol_hor::source_nn_hor_ih( const Scalar& trk_point, const Scalar* p_ener_dens, const Vector* p_mom_dens, 
                const Scalar* p_trace_stress) {
...
Vector Isol_hor::source_beta_hor_ih( const Scalar* p_ener_dens, const Vector* p_mom_dens, 
                const Scalar* p_trace_stress) {
