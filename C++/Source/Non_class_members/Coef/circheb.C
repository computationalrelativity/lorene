...
char circheb_C[] = "$Header$" ;


/*
 * Transformation de Tchebyshev inverse (cas fin) sur le troisieme indice 
...
void circheb(const int* deg, const int* dimc, double* cf, const int* dimf,
		double* ff)
...
// Nombre de points pour la FFT inverse:
    int nm1 = nr - 1;
    int nm1s2 = nm1 / 2;

// Recherche des tables pour la FFT inverse:
