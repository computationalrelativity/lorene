...
class Star {
	...
	/* Total of the part of $beta = ln(\psi^2 * N)$
	...
	const Scalar& get_beta() const {return beta;} ;
...
class Star_bin : public Star {
	...
	/** Effective source at the previous step for the resolution of 
	 *  the Poisson equation for {\tt beta\_auto}.
	 */
	Scalar ssjm1_beta ;
	...
	/**
	  * Function used to construct the part $beta_auto$ generated by 
	  * the star  from the total $beta$.
	 ...
	 *   by the star. 
	 */
	const Scalar& get_beta_auto() const {return beta_auto;} ;

	/** Returns the part of the vector field $Q$ generated principaly 
	 *   by the companion star. 
	 */
	const Scalar& get_beta_comp() const {return beta_comp;} ;
	...
	/** Returns the part of 
	 *  $\tilde K^{ij} \tilde K_{ij}$ generated by {\tt shift\_auto}. 
	 */
	const Scalar& get_kcar_auto() const {return kcar_auto;} ;

	/** Returns the part of 
	 *  $\tilde K^{ij} \tilde K_{ij}$ generated by {\tt shift\_comp}. 
	 */
	...
	*/
	 ...
	 *  {\tt hij\_auto}, {\tt comp.logn\_auto},  {\tt comp.beta\_auto},
	...
	/** Function used to update {\tt beta\_auto} and {\tt logn\_auto}
	 ...
	 *  {\tt beta\_auto}, {\tt shift\_auto}  and {\tt hij\_auto}. 
	 * 
