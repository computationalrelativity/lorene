...
char et_bin_bhns_extr_eq_ylm_C[] = "$Header$" ;
...
void Et_bin_bhns_extr::equil_bhns_extr_ylm(double ent_c, const double& mass,
					   const double& sepa,
					   double* nu_int, double* beta_int,
					   double* shift_int, int mermax,
					   int mermax_poisson,
