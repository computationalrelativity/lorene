...
void cirlegp(const int* , const int* , double*, const int* ,
		double* )
{
  c_est_pas_fait("cirlegp") ;

}


void cirlegi(const int* , const int* , double*, const int* ,
		double* )
{
  c_est_pas_fait("cirlegi") ;
