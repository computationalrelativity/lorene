...
###################################################################
ini.d
0.7	fact_separ : Factor by which the initial separation is multiplied
1.51	mbar_voulue[0] : Baryon mass required for star 1 [M_sol]
1.51	mbar_voulue[1] : Baryon mass required for star 2 [M_sol]
###################################################################
...
5	fmer_save : Step interval between safeguard of the whole configuration 
...
10	mer_masse : Step from which the baryon mass is forced to converge
0.5	aexp_masse : Exponent for the increase factor of the central enthalpy
4	fmer_udp_met : Step interval between metric updates
...
0.5	fact_omeg_min : fact_omeg_min * omega = low bound in the omega search
1.8	fact_omeg_max : fact_omeg_max * omega = high bound in the omega search
0.	thres_adapt : threshold on dH/dr for the adaptation of the mapping for star 1
0.	thres_adapt : threshold on dH/dr for the adaptation of the mapping for star 2
0.6     Factor reduce_shift
