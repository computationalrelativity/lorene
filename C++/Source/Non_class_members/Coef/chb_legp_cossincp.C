...
char chb_legp_cossincp_C[] = "$Header$" ;
 ...
 * LORENE
 *
 * Revision 2.0  1999/02/22  15:45:03  hyc
 * *** empty log message ***
 *
 *
 * $Header$
...
void chb_legp_cossincp(const int* deg , const double* cfi, double* cfo) {
...
// Recherche de la matrice de passage  Legendre -->  cos/sin 
    double* bb = mat_legp_cossincp(np, nt) ;
