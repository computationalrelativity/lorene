...
void Excised_slice::compute_stat_metric(double precis,  double Omega, bool NorKappa, Scalar boundNoK, bool isCF,double relax, int mer_max, int mer_max2, bool isvoid){
...
//      maxabs (baba - source_npsi);
  ...
  //  coupe_l_tous (hij, aa, nn, ppsi, bb, nt, 6); // cuts off high spherical harmonics with threshold being the last argument.
