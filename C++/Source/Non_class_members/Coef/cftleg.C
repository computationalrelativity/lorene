 ...
 * $Id$
 * $Log$
 * Revision 1.4  2014/10/13 08:53:09  j_novak
...
void cftleg(const int* deg, const int* dimf, double* ff, const int* dimc,
		double* cf)
{
...
//--------------------------------------------------------------
    ...
    cftcossinc(deg, dimf, ff, dimc, cf_cs) ;

//--------------------------------------------------------------
// 2/ Transformation  cos(l theta)/sin(l theta) ---> Legendre 
//--------------------------------------------------------------
