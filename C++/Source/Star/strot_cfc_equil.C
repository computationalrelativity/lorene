/*
 *  Function Star_rot_CFC::equilibrium
 *
...
namespace Lorene {
void Star_rot_CFC::equilibrium(double ent_c, double omega0, 
  ...
  if (mer_change_omega < mer_rot) {
    cout << "Star_rot_CFC::equilibrium: mer_change_omega < mer_rot !" 
	 << endl ;
  ...
  if (mer_fix_omega < mer_change_omega) {
    cout << "Star_rot_CFC::equilibrium: mer_fix_omega < mer_change_omega !" 
	 << endl ;
