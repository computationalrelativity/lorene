...
char cftcossincp_C[] = "$Header$" ;


/*
 * Transformation en cos(2*l*theta) ou sin((2*l+1)*theta) (suivant la parite
 ...
 * Modif commentaires.
 *
 * Revision 2.0  1999/02/22  15:47:32  hyc
 * *** empty log message ***
 *
 *
 * $Header$
...
// Tests de dimension:
    if (nt > n2f) {
	cout << "cftcossincp: nt > n2f : nt = " << nt << " ,  n2f = " 
	<< n2f << endl ;
	abort () ;
	exit(-1) ;
    }
    if (nt > n2c) {
	cout << "cftcossincp: nt > n2c : nt = " << nt << " ,  n2c = " 
	<< n2c << endl ;
	abort () ;
	exit(-1) ;
    }
    if (n1f > n1c) {
	cout << "cftcossincp: n1f > n1c : n1f = " << n1f << " ,  n1c = " 
	<< n1c << endl ;
	abort () ;
	exit(-1) ;
    }
    if (n3f > n3c) {
	cout << "cftcossincp: n3f > n3c : n3f = " << n3f << " ,  n3c = " 
	<< n3c << endl ;
	abort () ;
	exit(-1) ;
    }
...
//--------------------------------------------------------------------
//  partie cos(m phi) avec m pair : transformation en cos(2 l theta)
//--------------------------------------------------------------------
...
//--------------------------------------------------------------------
//  partie sin(m phi) avec m pair : transformation en cos(2 l theta)
//--------------------------------------------------------------------
...
//------------------------------------------------------------------------
//  partie cos(m phi) avec m impair : transformation en sin((2 l+1) theta)
//------------------------------------------------------------------------
...
//------------------------------------------------------------------------
//  partie sin(m phi) avec m impair : transformation en sin((2 l+1) theta)
//------------------------------------------------------------------------
