 ...
 * $Id$
 * $Log$
 * Revision 1.6  2014/10/13 08:53:12  j_novak
 ...
 * LORENE
 *
 * Revision 2.0  1999/02/22  15:41:37  hyc
 * *** empty log message ***
 *
 *
 * $Header$
...
void citlegp(const int* deg, const int* dimc, double* cf, const int* dimf,
		   double* ff)
{
...
//--------------------------------------------------------------
// 1/ Transformation Legendre ---> cos(2l theta)/sin((2l+1)theta)
//--------------------------------------------------------------

      chb_legp_cossincp(deg , cf, cf_cs) ;  

//--------------------------------------------------------------
// 2/ Transformation cos(2l theta)/sin((2l+1)theta) ---> esp. des configurations
//--------------------------------------------------------------

    citcossincp(deg, dimc, cf_cs, dimf, ff) ;
