 ...
 * $Id$
 * $Log$
 * Revision 1.10  2004/01/14 15:47:37  f_limousin
 * Initial revision
 *
 * Revision 1.9  2003/10/13 10:34:17  f_limousin
 * *** empty log message ***
 *
 * Revision 1.8  2003/06/25 11:59:52  f_limousin
 * Change to avoid an error in lorene_up with latex.
 *
...
class Et_bin_ncp : public Etoile_bin {
  ...
  /** Part of the 3_metric tilde 
   ...
   /** Part of the 3_metric tilde 
    ...
    Tenseur_sym hij ;
    Tenseur_sym hij_auto ;
    Tenseur_sym hij_comp ;
    Tenseur_sym ricci_auto ;
    Tenseur ricci_scal ;
    Tenseur qq ;
    Tenseur deltakij ;
    Tenseur deltakij_auto ;
    ...
    /** Effective source at the previous step for the resolution of 
     *  the Poisson equation for {\tt hij00\_auto} by means of
     *  {\tt Map\_et::poisson}.
     */
    Cmp ssjm1_hij00 ; 
	
    /** Effective source at the previous step for the resolution of 
     *  the Poisson equation for {\tt hij10\_auto} by means of
     *  {\tt Map\_et::poisson}.
     */
    Cmp ssjm1_hij10 ;
 
    /** Effective source at the previous step for the resolution of 
     *  the Poisson equation for {\tt hij20\_auto} by means of
     *  {\tt Map\_et::poisson}.
     */
    Cmp ssjm1_hij20 ; 

    /** Effective source at the previous step for the resolution of 
     *  the Poisson equation for {\tt hij11\_auto} by means of
     *  {\tt Map\_et::poisson}.
     */
    Cmp ssjm1_hij11 ; 

    /** Effective source at the previous step for the resolution of 
     *  the Poisson equation for {\tt hij21\_auto} by means of
     *  {\tt Map\_et::poisson}.
     */
    Cmp ssjm1_hij21 ; 

    /** Effective source at the previous step for the resolution of 
     *  the Poisson equation for {\tt hij22\_auto} by means of
     *  {\tt Map\_et::poisson}.
     */
    Cmp ssjm1_hij22 ; 

    /**
     * Function used to construct the part of {\tt a\_car} generated by the star 
     * from the total {\tt a\_car}. Only used for a binary system.
     * 
	...
	const Tenseur_sym& get_gtilde_auto_con() const {return gtilde_auto_con;} ;
	...
	const Tenseur& get_hij() const {return hij;} ;
	const Tenseur& get_hij_auto() const {return hij_auto;} ;
	const Tenseur& get_hij_comp() const {return hij_comp;} ;
   ...
   protected:
	 ...
	 *  logn_comp and a_car_auto when only {\tt beta\_auto} and 
