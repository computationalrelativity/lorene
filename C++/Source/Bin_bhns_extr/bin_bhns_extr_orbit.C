...
double fonc_bhns_orbit(double, const Param& ) ;

//************************************************************************

void Bin_bhns_extr::orbit_omega(double fact_omeg_min, double fact_omeg_max) {
  ...
  using namespace Unites ;
    ...
    Tbl* azer = 0x0 ;
    Tbl* bzer = 0x0 ;
    zero_list(fonc_bhns_orbit, parf, omega1, omega2, nsub,
	      azer, bzer) ;
    ...
    omega = zerosec_b(fonc_bhns_orbit, parf, omeg_min, omeg_max,
...
double fonc_bhns_orbit(double om, const Param& parf) {
