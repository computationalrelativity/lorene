...
class Star_bin : public Star {
	...
	/** Effective source at the previous step for the resolution of 
	 *  the Poisson equation for \c phi . (first scalar equation 
	...
	/** Effective source at the previous step for the resolution of 
	 *  the Poisson equation for \c mu . (third scalar equation 
	 *  for the resolution of the vectorial poisson equation for the shift)
	 */
	Scalar ssjm1_mu ;
	...
	/// Read/write of \f$shift\_auto\f$
	Vector& set_shift_auto() ;	

	/// Read/write of \f$shift\f$
	Vector& set_shift() ;	
	 ...
	 *  \f$\tilde K^{ij}\f$ generated by \c shift_auto . 
	 *  (Spherical components with respect to the mapping of the star)
	 */
	const Sym_tensor& get_tkij_auto() const {return tkij_auto;} ;

	/** Returns the part of the extrinsic curvature tensor 
	 *  \f$\tilde K^{ij}\f$ generated by \c shift_comp . 
	 *  (Spherical components with respect to the mapping of the star)
	 */
	const Sym_tensor& get_tkij_comp() const {return tkij_comp;} ;

	/** Returns the part of 
	 *  \f$\tilde K^{ij} \tilde K_{ij}\f$ generated by \c shift_auto . 
	 */
	const Scalar& get_kcar_auto() const {return kcar_auto;} ;

	/** Returns the part of 
	 *  \f$\tilde K^{ij} \tilde K_{ij}\f$ generated by \c shift_comp . 
	 */
	...
	*/
	 ...
	 *  \c hij_comp , \c nnn ,  \c psi4 ,  \c shift ,
	 *  
