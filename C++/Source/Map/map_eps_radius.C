/*
 *  Methods of the class Map_eps relative to the function
 *	    r = R_l(xi, theta', phi')
 */
...
namespace Lorene {
double Map_eps::val_r(int l, double xi, double theta, double pphi) const {
	...
	case UNSURR: {
	    cout << "Map_eps::val_r : Compactified domain not allowed !" << endl;
        abort() ;
	    break ;
	}

	default: {
	    cout << "Map_eps::val_r: unknown type_r ! " << endl ;
	    abort () ;
	}	   
    }
...
void Map_eps::val_lx(double rr, double theta, double pphi, int& lz, double& xi) const {
	...
	cout << "Map_eps::val_lx: the domain containing r = " << rr <<
		 " has not been found ! " 
	      << endl ;
	// for (int l=0; l<nz; l++) {
	...
	case UNSURR: {
	    cout << "Map_eps::val_lx : Compactified domain not allowed !" << endl;
        abort() ;
	    break ;
	}

	default: {
	    cout << "Map_eps::val_lx: unknown type_r ! " << endl ;
	    abort () ;
	}	   
    }
...
void Map_eps::val_lx(double rr, double theta, double pphi, const Param&,  
...
double Map_eps::val_r_jk(int l, double xi, int j, int k) const {
