...
class Star_bhns : public Star {
	...
	/// Lapse function generated by the companion black hole
	Scalar lapse_comp ;

	/// Total lapse function
	Scalar lapse_tot ;

	/** Derivative of the lapse function generated by the star
	 *  \f$ \partial_j \alpha \f$
	 */
	Vector d_lapse_auto ;

	/** Derivative of the lapse function generated by the companion
	 *  black hole
	 */
	Vector d_lapse_comp ;
	 ...
	 *  the Poisson equation for \c lapse_auto .
	 */
	Scalar ssjm1_lapse ;
	...
	/// Read/write of the lapse function generated by the neutron star
	Scalar& set_lapse_auto() ;

	/** Read/write of the lapse function generated by the companion
	 *  black hole
	 */
