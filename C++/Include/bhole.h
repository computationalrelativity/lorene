...
class Bhole {
	...
	void fait_psi_comp (const Bhole& comp) ;
		/**
	 * Imports the part of {\it N} due to the companion ns {\tt comp}. The 
	 * total {\it N} is then calculated.
	 * 
	 * It also imports the gradient of {\it N} and construct the total $\nabla N$.
	 */
	void fait_n_comp (const Etoile_bin& comp) ;
	
	/**
	 * Imports the part of $\Psi$ due to the companion ns {\tt comp}. The 
	 * total $\Psi$ is then calculated.
	 * 
	 * It also imports the gradient of $\Psi$ and construct the total $\nabla \Psi$.
	 */
	void fait_psi_comp (const Etoile_bin& comp) ;
	 ...
	 * velocity.
	 * 
	 * {\bf WARNING : } this should only be used for a black hole in 
	 * a binary system {\tt Bhole_binaire} or {\tt Bin_ns_bh}.
	 * 
